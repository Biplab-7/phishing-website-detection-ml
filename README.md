...
The final system extends the model into a Flask-based web application where a user can enter a URL and receive a prediction along with confidence and detected indicators.
